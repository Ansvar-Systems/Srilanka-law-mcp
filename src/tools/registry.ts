/**
 * Tool registry for Sri Lanka Law MCP Server.
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Sri Lanka Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Sri Lankan legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Sri Lankan statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Sri Lankan statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Sri Lankan legal citation against the database — zero-hallucination check. ' +
      ...
      'Supports formats: "Section 25, Data Protection Act 2019", "s 25, DPA 2019", "Article 31, Constitution of Sri Lanka 2010".',
    inputSchema: {
      type: 'object',
      properties: {
        citation: {
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Sri Lankan statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Sri Lanka?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Sri Lankan legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Sri Lankan statute or provision is currently in force, amended, repealed, partially suspended, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Sri Lankan statute aligns with or references. ' +
      'Sri Lanka is not an EU member but several Sri Lankan laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Sri Lankan statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  },
  {
    ...
    description:
      ...
      'Note: Sri Lanka implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Sri Lankan implementing/aligning legislation. ' +
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Sri Lankan statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Sri Lankan statute or provision. ' +
