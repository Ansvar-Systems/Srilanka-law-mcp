# Sri Lanka Law MCP Server — Developer Guide
...
Sri Lanka Law MCP server providing Sri Lankan legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Sri Lanka uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Sri Lanka Law -> JSON seed files in `data/seed/`
...
- **Sri Lanka Law** (sri lankalaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Sri Lanka 2010, selected case law

## Sri Lanka-Specific Notes

- Sri Lanka uses a common law legal system inherited from British colonial administration
- The Constitution of Sri Lanka 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Sri Lanka 2010"
...
- npm package: `@ansvar/sri lanka-law-mcp` with bin entry for stdio
