#!/usr/bin/env tsx
/**
 * Database builder for Sri Lanka Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Sri Lanka Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Sri Lankan statute text',
              );
