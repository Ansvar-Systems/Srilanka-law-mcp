 ...
 * from lawnet.gov.lk (Akoma Ntoso HTML).
 *
 * Features:
 ...
 *
 * Data source: lawnet.gov.lk (National Council for Law Reporting)
...
import { parseSri LankaLawHtml, type ActIndexEntry, type ParsedAct } from './lib/parser.js';
...
async function main(): Promise<void> {
  ...
  console.log('====================================================\n');
  console.log(`  Source: lawnet.gov.lk (National Council for Law Reporting)`);
  ...
  for (const law of acts) {
    ...
    try {
      ...
      const parsed = parseSri LankaLawHtml(html, act);
  ...
  console.log(`\n  Source:      lawnet.gov.lk (Akoma Ntoso HTML)`);
